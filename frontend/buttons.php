...
function ivy_button_product_page()
{
    ...
    if ($visibility == 'Yes') {
        echo '<button class="ivy-checkout-button" type="button" data-cart-value=' . $carttotal . 'data-cart-value=' . get_option('woocommerce_currency') . 'data-theme=' . $theme . 'data-locale="de"></button>';
    }
}
