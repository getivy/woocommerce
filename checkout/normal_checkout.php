<?php
add_action('wp_ajax_normal_function', 'normal_function');
add_action('wp_ajax_nopriv_normal_function', 'normal_function');
...
if ($getInfo['http_code'] === 200) {
  $exe_json = json_decode($exe);
  $result = array(
    'redirectUrl' => $exe_json->redirectUrl,
    'status'=>true
  );
  ob_clean();
